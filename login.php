                            ...
                            <div class="content">
                                <div class="buttons-set">
                                  <ul class="form-list">
                                      ...
                                      <li>
                                          <label for="pass">Tên... <span class="required">*</span></label>
                                          <br>
                                          <input type="password" title="Password" id="pass" class="input-text" name="login[password]">
                                      </li>
                                      <li>
                                          <label for="pass">Tên tài khoản <span class="required">*</span></label>
                                          <br>
                                          <input type="password" title="Password" id="pass" class="input-text" name="login[password]">
                                      </li>
                                      <li>
                                          <label for="pass">Địa chỉ email <span class="required">*</span></label>
                                          <br>
                                          <input type="password" title="Password" id="pass" class="input-text" name="login[password]">
                                      </li>
                                      <li>
